...
bureau_balance_df = getdata.get_bureaubal()
credit_card_df = getdata.get_credit()
pos_cash_df = getdata.get_pos()
prev_app_df = getdata.get_prev()
install_df = getdata.get_install()
# for cheking
