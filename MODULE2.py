...
class XGB :
    ...
    def preprocess_data_for_testset(self):
        ...
        with open ('features_module2.txt', 'rb') as fp:
    ...
    def preprocess_data_for_trainset(self):
        ...
        #print(self.features)
        with open('features_module2.txt', 'wb') as fp:
    ...
    def save_module(self):
        ...
        pickle.dump(self.model, open("module2.dat", "wb"))
        print("DONE !")

    def retrieve_module(self):
        print("I Am RETRIEVING MODEL !")
        self.model = pickle.load(open("module2.dat", "rb"))
        print("DONE !")
    ...
    def _prediction(self):
        ...
        self.results.to_csv("results_from_modeul2.csv",index=False,columns=self.results.columns)
        print("DONE !")
